...
local C = {
    BG_BASE      = Color3.fromRGB(10,  14,  20),
    BG_SIDEBAR   = Color3.fromRGB(12,  17,  24),
    BG_CONTENT   = Color3.fromRGB(14,  20,  30),
    BG_CARD      = Color3.fromRGB(18,  26,  38),
    BG_CARD_HVR  = Color3.fromRGB(21,  31,  46),
    BG_INPUT     = Color3.fromRGB(16,  23,  33),
    BG_BTN       = Color3.fromRGB(20,  30,  44),
    BG_BTN_HVR   = Color3.fromRGB(0,   80,  110),
    BG_NAV_ACT   = Color3.fromRGB(17,  30,  46),
    ACCENT       = Color3.fromRGB(56,  189, 248),
    ACCENT_DIM   = Color3.fromRGB(30,  100, 140),
    ACCENT_GLOW  = Color3.fromRGB(0,   150, 200),
    LINE         = Color3.fromRGB(28,  40,  58),
    LINE_CARD    = Color3.fromRGB(32,  48,  68),
    LINE_CARD_HI = Color3.fromRGB(56,  189, 248),
    TXT_BRIGHT   = Color3.fromRGB(235, 242, 255),
    TXT_MID      = Color3.fromRGB(140, 168, 200),
    TXT_DIM      = Color3.fromRGB(70,  95,  125),
    TXT_ACCENT   = Color3.fromRGB(56,  189, 248),
...
local Scripts = {
    Fuun = {
        ...
        {Name="Vd Pc",         Desc="ytta.",                              Tags={"Fuun"}, URL="https://violencedistrict.mpanhub.me/"},
        {Name="Vd Mobile",     Desc="ytta.",                              Tags={"Fuun"}, URL="https://violencedistrict.mpanhub.me/"},
...
Panel.Position = UDim2.new(0.5, -230, 0.5, 20)
...
PanelStroke.Color = Color3.fromRGB(56, 189, 248)
